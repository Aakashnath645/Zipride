...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'inline-flex h-10 items-center justify-center rounded-lg bg-[var(--surface-raised)] p-1 text-[var(--text-muted)]',
      className
    )}
    {...props}
  />
